    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-start justify-between">
        ...
        <div className="relative">
          ...
          {exportOpen ? (
            <div className="absolute right-0 mt-2 w-40 rounded-md border-slate-200/70 bg-white/90 shadow-elevated backdrop-blur dark:border-slate-700/60 dark:bg-slate-900/70 p-2 shadow-md z-20 hover:bg-white/20">
              <button
