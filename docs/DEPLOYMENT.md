...
> ⚠️ **Примечание по Prisma v7:** проект использует Prisma версии 7. Если вы обновляете зависимости вручную, убедитесь, что и `prisma` (devDependency), и `@prisma/client` (dependency) обновлены до версии 7. После обновления зависимостей выполните генерацию клиента и при необходимости создайте/примените миграции перед запуском сервера.
...
4. Примените миграции:
   ...
   ```powershell
   # сгенерировать клиент @prisma/client
